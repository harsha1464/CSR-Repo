          ...
          <div className="text-center scroll-reveal mt-8 space-y-8">
            <div className="flex flex-col items-center space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 sm:justify-center">
              ...
              <a 
                ...
                className="cta-button inline-block bg-[#808080] text-white px-3 py-4 sm:px-5 sm:py-4 rounded-md font-semibold text-md sm:text-lg border-2 border-grey w-64 max-w-xs sm:max-w-none"
              >
                Register for Awards
              </a>
            </div>
